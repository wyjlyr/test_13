...
<script type="text/javascript" src="${pageContext.request.contextPath }/bootstrap/js/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
	...
	<script type="text/javascript">
		...
		function jiaoyan(names) {

			$.ajax({
				method: "get",
				url: "/category/checkCname/" + names,
				success: function (data) {
					if (data) {
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text"  name="goods_name" onblur="jiaoyan(this.value)" value="" class="form-control" id="goodsName" placeholder="商品名称">
									</div>
									<div id="checkName">
...
<%--											<option>肉食类</option> --%>
				...
				<div class="panel-body text-center">
					...
					<!-- 表单提交按钮 -->
					<button type="submit" id="xx"  class="btn btn-primary btn-lg" >
